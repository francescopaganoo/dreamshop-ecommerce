...
import { getFilteredProductsPlugin, Product, ExtendedCategory, AttributeValue, Brand } from '@/lib/api';
                  ...
                  <div className="flex items-center space-x-1 overflow-x-auto">
                    ...
                    {(() => {
                      ...
                      if (start > 1) {
                        ...
                        pageNumbers.push(
                          <Link key={1} href={`/products?${firstParams.toString()}`}
                      ...
                      for (let i = start; i <= end; i++) {
                        if (i === page) {
                          ...
                          pageNumbers.push(
                            <Link key={i} href={`/products?${pageParams.toString()}`}
                              className="px-2 sm:px-3 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-100 text-sm sm:text-base">
                              {i}
                            </Link>
                          );
                      ...
                      if (end < maxPage) {
                        ...
                        pageNumbers.push(
                          <Link key={maxPage} href={`/products?${lastParams.toString()}`}
                            className="px-2 sm:px-3 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-100 text-sm sm:text-base">
                            {maxPage}
                          </Link>
                        );
...
export default function ProductsClient(props: ProductsClientProps) {
  return <ProductsClientContent {...props} />;
}
