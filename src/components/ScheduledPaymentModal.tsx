            ...
            <div className="grid grid-cols-1 gap-4 mb-6">
              ...
              >
                <svg className="h-8 w-8" viewBox="0 0 24 24" fill="#003087">
                  <path d="M20.067 8.478c.492.88.156 2.56-1.182 4.44-.987 1.404-2.37 2.228-4.027 2.228h-.042c-.35 1.798-2.145 2.114-4.09 2.114h-4.318l-.59 3.65h-1.773l.033-.032.196-1.246.012-.032h1.956l.507-3.65h1.3l.032-.032h4.145c.842 0 1.525-.05 2.11-.196 2.316-.576 3.674-2.524 3.733-4.242v-.394c0-.032 0-.066-.004-.098.586.98.9.208.12.328.065.164.11.35.134.546v.394c-.06 1.718-1.42 3.664-3.733 4.242-.586.148-1.27.196-2.11.196h-2.93l-.59 3.688h-3.633l.59-3.688h-1.3l-.59 3.688h-1.89l1.376-8.804h5.253c1.96 0 3.802-.32 4.12-2.146.16-.916-.062-1.888-.59-2.538.535-.064 1.055-.032 1.52.138.33.114.618.296.842.516z"/>
                  <path d="M9.68 7.062c.094-.608.534-.976 1.023-.976h5.418c.25 0 .466.028.65.08-.55-2.114-2.48-2.43-4.13-2.43H7.387l-1.67 10.634h4.063c1.945 0 3.738-.316 4.09-2.114h-3.074c-.762 0-1.256-.364-1.115-1.372v-.004l.014-.068c0-.004.004-.008.004-.016l.3-1.896v-.004c.008-.042.016-.08.024-.126.1-.528.55-.878 1.054-.878h.948L12 9.044h.234l.32-.006h1.637c.876 0 1.674.176 2.192.516-.22-.874-.885-1.492-2.37-1.492H9.68z" fill="#0070E0"/>
                </svg>
